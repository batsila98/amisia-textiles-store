...
class ModelCheckoutOrder extends Model {
	public function addOrder($data) {
		...
		// trofimenk0
		if($data['novaposhtaData']) {
			$area = $data['novaposhtaData']['novaposhtaArea'];
			$city = $data['novaposhtaData']['novaposhtaCity'];
			$office = $data['novaposhtaData']['novaposhtaOffice'];
		} else {
			$area = null;
			$city = null;
			$office = null;
