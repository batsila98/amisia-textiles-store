	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				//trofimenk0
				'novaposhta_area'         => $order_query->row['novaposhta_area'],
				'novaposhta_city'         => $order_query->row['novaposhta_city'],
				'novaposhta_office'       => $order_query->row['novaposhta_office'],
				'ukrposhta_city'         => $order_query->row['ukrposhta_city'],
				'ukrposhta_office'       => $order_query->row['ukrposhta_office'],
